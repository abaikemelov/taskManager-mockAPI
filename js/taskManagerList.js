...
function fetchData() {
    return new Promise((resolve, reject) => {
        ...
        xhr.open("GET", `https://657436ebf941bda3f2af7b89.mockapi.io/api/v1/user/${userId}/Task`, true);
...
function getFilteredTasks(completed) {
    return new Promise((resolve, reject) => {
        const xhr = new XMLHttpRequest();
        xhr.open("GET", `https://657436ebf941bda3f2af7b89.mockapi.io/api/v1/user/${userId}/Task?completed=${completed}`, true);
...
function deleteTask(id) {
    return new Promise((resolve, reject) => {
        const xhr = new XMLHttpRequest();
        xhr.open("DELETE", `https://657436ebf941bda3f2af7b89.mockapi.io/api/v1/user/${userId}/Task/${id}`, true);
...
function checkTask(id, completed) {
    return new Promise((resolve, reject) => {
        const xhr = new XMLHttpRequest();
        xhr.open("PUT", `https://657436ebf941bda3f2af7b89.mockapi.io/api/v1/user/${userId}/Task/${id}`, true);
...
function postTask(title, desc) {
    return new Promise((resolve, reject) => {
        const xhr = new XMLHttpRequest();
        xhr.open("POST", `https://657436ebf941bda3f2af7b89.mockapi.io/api/v1/user/${userId}/Task/`, true);
        xhr.setRequestHeader("Content-Type", "application/json");
